...
extension Snapshotting where Value == CGPath, Format == NSImage {
  ...
  public static func image(precision: Float = SnapshottingImageDefaults.precision, subpixelThreshold: UInt8 = SnapshottingImageDefaults.subpixelThreshold, drawingMode: CGPathDrawingMode = .eoFill) -> Snapshotting {
...
extension Snapshotting where Value == CGPath, Format == UIImage {
  ...
  public static func image(precision: Float = SnapshottingImageDefaults.precision, subpixelThreshold: UInt8 = SnapshottingImageDefaults.subpixelThreshold, scale: CGFloat = 1, drawingMode: CGPathDrawingMode = .eoFill) -> Snapshotting {
