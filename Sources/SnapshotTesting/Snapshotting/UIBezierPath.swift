...
extension Snapshotting where Value == UIBezierPath, Format == UIImage {
  ...
  public static func image(precision: Float = SnapshottingImageDefaults.precision, subpixelThreshold: UInt8 = SnapshottingImageDefaults.subpixelThreshold, scale: CGFloat = 1) -> Snapshotting {
